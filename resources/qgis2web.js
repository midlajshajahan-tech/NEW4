...
map.getView().fit([8553439.495671, 1001903.748352, 8570491.344546, 1012872.336103], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ADMINISTARTIVE DIVISONS- PUNALUR</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (141 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is the Updated Administartive Divisions of Punalur Muncipality as per the Delimitation Commisiion of 2025. This is meant for test study.';
            }
